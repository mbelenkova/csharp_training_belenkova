...
namespace addressbook_web_main
{
    ...
    public class UntitledTestCase
    {
        ...
        public void SetupTest()
        {
            ...
            baseURL = "http://localhost/edit.php";
        ...
        private void FillInDataFields(ContactData contact)
        {
            //fill in data fields
           ...
           // driver.FindElement(By.Name("photo")).SendKeys("D:\test.png");
        ...
        private void Login(AccountData account1)
        {
            //login
            driver.FindElement(By.Name("user")).Clear();
            driver.FindElement(By.Name("user")).SendKeys(account1.Username);
            driver.FindElement(By.Name("pass")).Click();
            driver.FindElement(By.Name("pass")).Clear();
            driver.FindElement(By.Name("pass")).SendKeys(account1.Password);
            driver.FindElement(By.XPath("//input[@value='Login']")).Click();
        }

        private void GoToHomePahe()
        {
            //open homepage
